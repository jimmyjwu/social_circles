...
NUMBER_OF_FRIENDS_PER_FRIENDSHIP_QUERY = lambda number_of_friends, graph_density=DEFAULT_GRAPH_DENSITY: int(SAFE_RESULTS_PER_QUERY / graph_density / number_of_friends)